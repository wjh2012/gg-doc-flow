...
| **common-worker**  | @app/common-worker  | 워커 베이스 클래스, BullMQ 설정, 큐 상수, Payload 타입 |
| **common-logging** | @app/common-logging | OpenTelemetry, 로깅                       |

| **ocr-client**       | @app/ocr-client | OCR gRPC 클라이언트 |
| **detection-client** | @app/detection-client | Detection gRPC 클라이언트 |
